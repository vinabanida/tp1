...
public class ViewNewAccount {
	...
	*/
	...
	// This alert tells the user the user name is invalid
	...
	*/
	...
	private ViewNewAccount() {
		...
		alertUserNameError.setHeaderText("Username can only start with A-Z or a-z");
		alertUserNameError.setContentText("Try another username.");
